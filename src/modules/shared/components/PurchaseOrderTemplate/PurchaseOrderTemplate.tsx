...
const PurchaseOrderTemplate: React.FC<IPurchaseOrderTemplateProps> = (props) => {
  ...
  const { purchaseOrderDate, purchaseOrderNumber,
      ...
      <View style={{ position: "absolute", left: "50%", marginLeft: "-297px", top: "0px", width: "595px", height: "842px", borderStyle: "solid", overflow:"hidden" }}>
        <Page size="A4">
          <View style={{ left: "0px", top: "0px" }}>
            ...
            <View style={{ position:"absolute", left: "367.68px", top: "31.26px", ...styles.cls_002 }}>
              <Text style={styles.cls_002}>P U R C H A S E   O R D E R</Text>
            </View>
            <View style={{ position: "absolute", left: "24.00px", top: "49.98px", ...styles.cls_003 }}>
              <Text style={styles.cls_003}>Lot 2958, Acku Inds. Estate</Text>
            </View>
            <View style={{ position: "absolute", left: "24.00px", top:"61.26px", ...styles.cls_003 }}>
              <Text style={styles.cls_003}>Jalan Bagan Lalang</Text>
            </View>
            <View style={{ position: "absolute", left: "414.01px", top: "61.26px", ...styles.cls_003 }}>
              <Text style={styles.cls_003}>DATE:</Text>
            </View>
            <View style={{ position: "absolute", left: "474.00px", top: "61.26px", ...styles.cls_003 }}>
              <Text style={styles.cls_003}>{purchaseOrderDate}</Text>
            </View>
            <View style={{ position: "absolute", left: "24.00px", top: "73.26px", ...styles.cls_003 }}>
              <Text style={styles.cls_003}>13400 Butterworth</Text>
            </View>
            <View style={{ position: "absolute", left: "414.00px", top: "73.26px", ...styles.cls_003 }}>
              <Text style={styles.cls_003}>PO:</Text>
            </View>
            <View style={{ position: "absolute", left: "474.00px", top: "73.26px", ...styles.cls_004 }}>
              <Text style={styles.cls_004}>{purchaseOrderNumber}</Text>
            </View>
            <View style={{ position: "absolute", left: "24.00px", top: "84.60px", ...styles.cls_003 }}>
              <Text style={styles.cls_003}>Penang Malaysia</Text>
            </View>
            <View style={{ position: "absolute", left: "414.00px", top: "84.60px", ...styles.cls_003 }}>
              <Text style={styles.cls_003}>PO Rev:</Text>
            </View>
            <View style={{ position: "absolute", left: "24.00px", top: "95.88px", ...styles.cls_003 }}>
              <Text style={styles.cls_003}>Phone:</Text>
            </View>
            <View style={{ position: "absolute", left: "60.00px", top: "95.88px", ...styles.cls_003 }}>
              <Text style={styles.cls_003}>04-4844208</Text>
            </View>
            <View style={{ position: "absolute", left: "414.00px", top: "95.88px", ...styles.cls_003 }}>
              <Text style={styles.cls_003}>Your Ref:</Text>
            </View>
            <View style={{ position: "absolute", left: "414.00px", top: "107.46px", ...styles.cls_003 }}>
            ...
            <View style={{ position: "absolute", left: "341.99px", top: "153.96px", ...styles.cls_003 }}>
              <Text style={styles.cls_003}>Engseen Bleaching &#38; Dyeing Sdn Bhd</Text>
            </View>
            <View style={{ position: "absolute", left: "24.00px", top: "165.30px", ...styles.cls_003 }}>
              <Text style={styles.cls_003}>{purchaseOrderVendorAddressLine1}</Text>
            </View>
            <View style={{ position: "absolute", left: "342.00px", top: "165.30px", ...styles.cls_003 }}>
              <Text style={styles.cls_003}>Lot 2958, Acku Inds. Estate</Text>
            </View>
            <View style={{ position: "absolute", left: "24.00px", top: "176.58px", ...styles.cls_003 }}>
              <Text style={styles.cls_003}>{purchaseOrderVendorAddressLine2}</Text>
            </View>
            <View style={{ position: "absolute", left: "341.99px", top: "176.58px", ...styles.cls_003 }}>
              <Text style={styles.cls_003}>Jalan Bagan Lalang</Text>
            </View>
            <View style={{ position: "absolute", left: "342.00px", top: "187.86px", ...styles.cls_003 }}>
              <Text style={styles.cls_003}>13400 Butterworth</Text>
            </View>
            <View style={{ position: "absolute", left: "342.00px", top: "199.20px", ...styles.cls_003 }}>
              <Text style={styles.cls_003}>Penang Malaysia</Text>
            </View>
            <View style={{ position: "absolute", left: "24.00px", top: "210.48px", ...styles.cls_003 }}>
              <Text style={styles.cls_003}>Phone:</Text>
            </View>
            <View style={{ position: "absolute", left: "60.00px", top: "210.48px", ...styles.cls_003 }}>
              <Text style={styles.cls_003}>04-4844208</Text>
            </View>
            <View style={{ position: "absolute", left: "21.00px", top: "256.86px", ...styles.cls_003 }}>
              <Text style={styles.cls_003}>SHIP VIA:</Text>
            </View>
            <View style={{ position: "absolute", left: "342.00px", top: "256.86px", ...styles.cls_003 }}>
            ...
            <View style={{ position: "absolute", left: "526.68px", top: "685.14px", ...styles.cls_004 }}>
              <Text style={styles.cls_004}>34,500.00</Text>
            </View>
            <View style={{ position: "absolute", left: "23.01px", top: "708.06px", ...styles.cls_003 }}>
              <Text style={styles.cls_003}>**This is a computer generated PO and does not require signature**</Text>
            </View>
            <View style={{ position: "absolute", left: "22.50px", top: "731.25px", ...styles.cls_006 }}>
            ...
            <View style={{ position: "absolute", left: "24.00px", top: "755.34px", ...styles.cls_007 }}>
              <Text style={styles.cls_007}>Acceptance of Order</Text>
            </View>
            <View style={{ position: "absolute", left: "24.00px", top: "777.66px", ...styles.cls_003 }}>
              <Text style={styles.cls_003}>Name:</Text>
            </View>
            <View style={{ position: "absolute", left: "24.00px", top: "789.00px", ...styles.cls_003 }}>
              <Text style={styles.cls_003}>Designation:</Text>
            </View>
            <View style={{ position: "absolute", left: "24.00px", top: "800.28px", ...styles.cls_003 }}>
              <Text style={styles.cls_003}>Date:</Text>
            </View>
            <View style={{ position: "absolute", left: "405.78px", top: "800.28px", ...styles.cls_003 }}>
        ...
        <Page size="A4">
          <View style={{ position: "absolute", left: "50%", marginLeft: "-297px", top: "852px", width: "595px", height: "842px", borderStyle: "solid", overflow:"hidden" }}>
            <View style={{ left: "0px", top: "0px" }}>
              ...
              <View style={{ position: "absolute", left: "56.70px", top: "55.86px", ...styles.cls_009 }}>
                <Text style={styles.cls_009}>CLAUSE 1. APPLICATION OF GENERAL PURCHASE TERMS AND CONDITIONS</Text>
              </View>
              <View style={{ position: "absolute", left: "325.98px", top: "55.86px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "56.70px", top: "61.56px", ...styles.cls_010 }}>
                <Text style={styles.cls_010}>1.1 The present GPTC shall apply to all Orders placed by Engseen Bleaching &#38; Dyeing Sdn. Bhd.</Text>
              </View>
              <View style={{ position: "absolute", left: "325.98px", top: "61.56px", ...styles.cls_010 }}>
                <Text style={styles.cls_010}>Clause.</Text>
              </View>
              <View style={{ position: "absolute", left: "56.70px", top: "67.32px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "325.98px", top: "67.32px", ...styles.cls_009 }}>
                <Text style={styles.cls_009}>CLAUSE 10. WARRANTY</Text>
              </View>
              <View style={{ position: "absolute", left: "56.70px", top: "73.08px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "325.98px", top: "73.08px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "56.70px", top: "78.84px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "325.98px", top: "78.84px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "56.70px", top: "84.60px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "325.98px", top: "84.60px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "56.70px", top: "90.36px", ...styles.cls_010 }}>
                <Text style={styles.cls_010}>estimate, general terms of purchase or such other documents in whatever form.</Text>
              </View>
              <View style={{ position: "absolute", left: "325.98px", top: "90.36px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "56.70px", top: "96.06px", ...styles.cls_009 }}>
                <Text style={styles.cls_009}>CLAUSE 2. CONTRACT FORMATION</Text>
              </View>
              <View style={{ position: "absolute", left: "325.98px", top: "96.06px", ...styles.cls_010 }}>
                <Text style={styles.cls_010}>applicable laws and regulations.</Text>
              </View>
              <View style={{ position: "absolute", left: "56.70px", top: "101.82px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "325.98px", top: "101.82px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "56.70px", top: "107.58px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "325.98px", top: "107.58px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "56.70px", top: "113.34px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "325.98px", top: "113.34px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "56.70px", top: "119.10px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "325.98px", top: "119.10px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "56.70px", top: "124.86px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "325.98px", top: "124.86px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "56.70px", top: "130.56px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "325.98px", top: "130.56px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "56.70px", top: "147.84px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "325.98px", top: "147.84px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "56.70px", top: "153.60px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "325.98px", top: "153.60px", ...styles.cls_010 }}>
                <Text style={styles.cls_010}>event of any defects found within the Warranty Period, Clause 11 shall apply.</Text>
              </View>
              <View style={{ position: "absolute", left: "56.70px", top: "159.30px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "325.98px", top: "159.30px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "56.70px", top: "165.06px", ...styles.cls_010 }}>
                <Text style={styles.cls_010}>to the transportation and delivery of the Goods being paid by the Supplier.</Text>
              </View>
              <View style={{ position: "absolute", left: "325.98px", top: "165.06px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "56.70px", top: "170.82px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "325.98px", top: "170.82px", ...styles.cls_010 }}>
                <Text style={styles.cls_010}>deemed to start anew and commence from the day on which such Goods or Works are changed,</Text>
              </View>
              <View style={{ position: "absolute", left: "56.70px", top: "176.58px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "325.98px", top: "176.58px", ...styles.cls_010 }}>
                <Text style={styles.cls_010}>modified, remedied or replaced for and additional period equivalent to the Warranty Period.</Text>
              </View>
              <View style={{ position: "absolute", left: "56.70px", top: "182.34px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "325.98px", top: "182.34px", ...styles.cls_009 }}>
                <Text style={styles.cls_009}>CLAUSE 11. REMEDYING DEFECTS OR REPAIR AND REPLACEMENT</Text>
              </View>
              <View style={{ position: "absolute", left: "56.70px", top: "188.10px", ...styles.cls_010 }}>
                <Text style={styles.cls_010}>Order for any such retention.</Text>
              </View>
              <View style={{ position: "absolute", left: "325.98px", top: "188.10px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "56.70px", top: "193.80px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "325.98px", top: "193.80px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "56.70px", top: "199.56px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "325.98px", top: "199.56px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "56.70px", top: "205.32px", ...styles.cls_010 }}>
                <Text style={styles.cls_010}>Engseen.</Text>
              </View>
              <View style={{ position: "absolute", left: "325.98px", top: "205.32px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "56.70px", top: "211.08px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "325.98px", top: "211.08px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "56.70px", top: "216.84px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "325.98px", top: "216.84px", ...styles.cls_010 }}>
                <Text style={styles.cls_010}>period agreed by Engseen.</Text>
              </View>
              <View style={{ position: "absolute", left: "56.70px", top: "222.60px", ...styles.cls_010 }}>
                <Text style={styles.cls_010}>approved by Engseen according to the terms stated in the Order.</Text>
              </View>
              <View style={{ position: "absolute", left: "325.98px", top: "222.60px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "56.70px", top: "228.30px", ...styles.cls_009 }}>
                <Text style={styles.cls_009}>CLAUSE 4. QUALITY AND SAFETY</Text>
              </View>
              <View style={{ position: "absolute", left: "325.98px", top: "228.30px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "56.70px", top: "234.06px", ...styles.cls_010 }}>
                <Text style={styles.cls_010}>4.1 All Goods supplied shall:</Text>
              </View>
              <View style={{ position: "absolute", left: "325.98px", top: "234.06px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "56.70px", top: "239.82px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "325.98px", top: "239.82px", ...styles.cls_010 }}>
                <Text style={styles.cls_010}>conforming Works or Defects which cannot be rectified or repaired by the Supplier.</Text>
              </View>
              <View style={{ position: "absolute", left: "56.70px", top: "245.58px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "325.98px", top: "245.58px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "56.70px", top: "251.34px", ...styles.cls_010 }}>
                <Text style={styles.cls_010}>applicable standards under the applicable law (“Specifications”);</Text>
              </View>
              <View style={{ position: "absolute", left: "325.98px", top: "251.34px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "56.70px", top: "257.10px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "325.98px", top: "257.10px", ...styles.cls_010 }}>
                <Text style={styles.cls_010}>shall be fully borne by the Supplier.</Text>
              </View>
              <View style={{ position: "absolute", left: "56.70px", top: "262.80px", ...styles.cls_010 }}>
                <Text style={styles.cls_010}>the Supplier; and</Text>
              </View>
              <View style={{ position: "absolute", left: "325.98px", top: "262.80px", ...styles.cls_009 }}>
                <Text style={styles.cls_009}>CLAUSE 12. INTELLECTUAL PROPERTY</Text>
              </View>
              <View style={{ position: "absolute", left: "56.70px", top: "268.56px", ...styles.cls_010 }}>
                <Text style={styles.cls_010}>4.1.3 free from defects in title, lien, encumbrances and claims.</Text>
              </View>
              <View style={{ position: "absolute", left: "325.98px", top: "268.56px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "56.70px", top: "274.32px", ...styles.cls_010 }}>
                <Text style={styles.cls_010}>4.2 All Works performed shall:</Text>
              </View>
              <View style={{ position: "absolute", left: "325.98px", top: "274.32px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "56.70px", top: "280.08px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "325.98px", top: "280.08px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "56.70px", top: "285.84px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "325.98px", top: "285.84px", ...styles.cls_010 }}>
                <Text style={styles.cls_010}>licences to allow it to sell the Goods and execute the Works to and for the Engseen.</Text>
              </View>
              <View style={{ position: "absolute", left: "56.70px", top: "291.54px", ...styles.cls_010 }}>
                <Text style={styles.cls_010}>Works to be executed.</Text>
              </View>
              <View style={{ position: "absolute", left: "325.98px", top: "291.54px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "56.70px", top: "297.30px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "325.98px", top: "297.30px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "56.70px", top: "303.06px", ...styles.cls_010 }}>
                <Text style={styles.cls_010}>Supplier and in accordance with the best industry practice.</Text>
              </View>
              <View style={{ position: "absolute", left: "325.98px", top: "303.06px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "56.70px", top: "308.82px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "325.98px", top: "308.82px", ...styles.cls_010 }}>
                <Text style={styles.cls_010}>proceedings and suits.</Text>
              </View>
              <View style={{ position: "absolute", left: "56.70px", top: "314.58px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "325.98px", top: "314.58px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "56.70px", top: "320.34px", ...styles.cls_010 }}>
                <Text style={styles.cls_010}>pursuant to Clause 11.</Text>
              </View>
              <View style={{ position: "absolute", left: "325.98px", top: "320.33px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "56.70px", top: "326.04px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "325.98px", top: "326.04px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "56.70px", top: "331.80px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "325.98px", top: "331.79px", ...styles.cls_010 }}>
                <Text style={styles.cls_010}>infringing yet remains functionally and substantially equivalent.</Text>
              </View>
              <View style={{ position: "absolute", left: "56.70px", top: "337.56px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "325.98px", top: "337.55px", ...styles.cls_009 }}>
                <Text style={styles.cls_009}>CLAUSE 13. BUYER’S DRAWINGS AND DOCUMENTS</Text>
              </View>
              <View style={{ position: "absolute", left: "56.70px", top: "343.32px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "325.98px", top: "343.32px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "56.70px", top: "349.08px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "325.98px", top: "349.08px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "56.70px", top: "354.83px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "325.98px", top: "354.84px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "56.70px", top: "360.54px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "325.98px", top: "360.54px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "56.70px", top: "366.29px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "325.98px", top: "366.30px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "56.70px", top: "372.05px", ...styles.cls_010 }}>
                <Text style={styles.cls_010}>site.</Text>
              </View>
              <View style={{ position: "absolute", left: "325.98px", top: "372.06px", ...styles.cls_010 }}>
                <Text style={styles.cls_010}>whether payment has been made to the Supplier.</Text>
              </View>
              <View style={{ position: "absolute", left: "56.70px", top: "377.81px", ...styles.cls_009 }}>
                <Text style={styles.cls_009}>CLAUSE 5. VARIATION</Text>
              </View>
              <View style={{ position: "absolute", left: "325.98px", top: "377.82px", ...styles.cls_009 }}>
                <Text style={styles.cls_009}>CLAUSE 14. INSURANCE</Text>
              </View>
              <View style={{ position: "absolute", left: "56.70px", top: "383.57px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "325.98px", top: "383.58px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "56.70px", top: "389.27px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "325.98px", top: "389.28px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "56.70px", top: "395.03px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "325.98px", top: "395.04px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "56.70px", top: "400.79px", ...styles.cls_010 }}>
                <Text style={styles.cls_010}>prices shall be reasonably agreed between the parties.</Text>
              </View>
              <View style={{ position: "absolute", left: "325.98px", top: "400.80px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "56.70px", top: "406.55px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "325.98px", top: "406.56px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "56.70px", top: "412.31px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "325.98px", top: "412.32px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "56.70px", top: "418.08px", ...styles.cls_010 }}>
                <Text style={styles.cls_010}>undertaken without a Variation Order.</Text>
              </View>
              <View style={{ position: "absolute", left: "325.98px", top: "418.08px", ...styles.cls_010 }}>
                <Text style={styles.cls_010}>which may result from such recourse and/or claim.</Text>
              </View>
              <View style={{ position: "absolute", left: "56.70px", top: "423.78px", ...styles.cls_009 }}>
                <Text style={styles.cls_009}>CLAUSE 6. DELIVERY OF GOODS AND COMPLETION OF WORKS</Text>
              </View>
              <View style={{ position: "absolute", left: "325.98px", top: "423.78px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "56.70px", top: "429.54px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "325.98px", top: "429.54px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "56.70px", top: "435.30px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "325.98px", top: "435.30px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "56.70px", top: "441.06px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "325.98px", top: "441.06px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "56.70px", top: "446.82px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "325.98px", top: "446.82px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "56.70px", top: "452.58px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "325.98px", top: "452.58px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "56.70px", top: "458.28px", ...styles.cls_010 }}>
                <Text style={styles.cls_010}>deliveries and may return the Goods at the Supplier’s costs and risks.</Text>
              </View>
              <View style={{ position: "absolute", left: "325.98px", top: "458.28px", ...styles.cls_009 }}>
                <Text style={styles.cls_009}>CLAUSE 15. CONFIDENTIALITY AND PUBLICITY</Text>
              </View>
              <View style={{ position: "absolute", left: "56.70px", top: "464.04px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "325.98px", top: "464.04px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "56.70px", top: "469.80px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "325.98px", top: "469.80px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "56.70px", top: "475.56px", ...styles.cls_010 }}>
                <Text style={styles.cls_010}>Date”).</Text>
              </View>
              <View style={{ position: "absolute", left: "325.98px", top: "475.56px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "56.70px", top: "481.32px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "325.98px", top: "481.32px", ...styles.cls_010 }}>
                <Text style={styles.cls_010}>consent of Engseen.</Text>
              </View>
              <View style={{ position: "absolute", left: "56.70px", top: "487.08px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "325.98px", top: "487.08px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "56.70px", top: "492.78px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "325.98px", top: "492.78px", ...styles.cls_010 }}>
                <Text style={styles.cls_010}>written approval of Engseen.</Text>
              </View>
              <View style={{ position: "absolute", left: "56.70px", top: "498.54px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "325.98px", top: "498.54px", ...styles.cls_009 }}>
                <Text style={styles.cls_009}>CLAUSE 16. TERMINATION</Text>
              </View>
              <View style={{ position: "absolute", left: "56.70px", top: "504.30px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "325.98px", top: "504.30px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "56.70px", top: "510.06px", ...styles.cls_010 }}>
                <Text style={styles.cls_010}>of the Supplier’s obligations or prejudice any of Engseen’s rights under the Contract.</Text>
              </View>
              <View style={{ position: "absolute", left: "325.98px", top: "510.06px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "56.70px", top: "515.82px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "325.98px", top: "515.82px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "56.70px", top: "521.52px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "325.98px", top: "521.52px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "56.70px", top: "527.28px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "325.98px", top: "527.28px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "56.70px", top: "533.04px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "325.98px", top: "533.04px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "56.70px", top: "538.80px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "325.98px", top: "538.80px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "56.70px", top: "544.56px", ...styles.cls_010 }}>
                <Text style={styles.cls_010}>delivery of the Goods and/or late completion of the Works.</Text>
              </View>
              <View style={{ position: "absolute", left: "325.98px", top: "544.56px", ...styles.cls_010 }}>
                <Text style={styles.cls_010}>claimed by Engseen from the Supplier.</Text>
              </View>
              <View style={{ position: "absolute", left: "56.70px", top: "550.32px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "325.98px", top: "550.32px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "56.70px", top: "556.02px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "325.98px", top: "556.02px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "56.70px", top: "561.78px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "325.98px", top: "561.78px", ...styles.cls_010 }}>
                <Text style={styles.cls_010}>claims for loss and damages by Engseen.</Text>
              </View>
              <View style={{ position: "absolute", left: "56.70px", top: "567.54px", ...styles.cls_010 }}>
                <Text style={styles.cls_010}>the suspension period, unless otherwise agreed by the Parties.</Text>
              </View>
              <View style={{ position: "absolute", left: "325.98px", top: "567.54px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "56.70px", top: "573.30px", ...styles.cls_009 }}>
                <Text style={styles.cls_009}>CLAUSE 7. TRANSFER OF TITLE AND RISK</Text>
              </View>
              <View style={{ position: "absolute", left: "325.98px", top: "573.30px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "56.70px", top: "579.06px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "325.98px", top: "579.06px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "56.70px", top: "584.82px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "325.98px", top: "584.82px", ...styles.cls_010 }}>
                <Text style={styles.cls_010}>the Goods and/or Works as stated in the Order.</Text>
              </View>
              <View style={{ position: "absolute", left: "56.70px", top: "590.52px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "325.98px", top: "590.52px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "56.70px", top: "596.28px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "325.98px", top: "596.28px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "56.70px", top: "602.04px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "325.98px", top: "602.04px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "56.70px", top: "607.80px", ...styles.cls_010 }}>
                <Text style={styles.cls_010}>hereunder.</Text>
              </View>
              <View style={{ position: "absolute", left: "325.98px", top: "607.80px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "56.70px", top: "613.56px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "325.98px", top: "613.56px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "56.70px", top: "619.26px", ...styles.cls_010 }}>
                <Text style={styles.cls_010}>as to them until the cure of the defect or acceptance by Engseen, whichever is earlier.</Text>
              </View>
              <View style={{ position: "absolute", left: "325.98px", top: "619.26px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "56.70px", top: "625.02px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "325.98px", top: "625.02px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "56.70px", top: "630.78px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "325.98px", top: "630.78px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "56.70px", top: "636.54px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "325.98px", top: "636.54px", ...styles.cls_010 }}>
                <Text style={styles.cls_010}>Works up to the date of termination of the Contract.</Text>
              </View>
              <View style={{ position: "absolute", left: "56.70px", top: "642.30px", ...styles.cls_010 }}>
                <Text style={styles.cls_010}>disposal thereof, against which the Supplier shall indemnify Engseen.</Text>
              </View>
              <View style={{ position: "absolute", left: "325.98px", top: "642.30px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "56.70px", top: "648.06px", ...styles.cls_009 }}>
                <Text style={styles.cls_009}>CLAUSE 8. INSPECTION AND TESTING</Text>
              </View>
              <View style={{ position: "absolute", left: "325.98px", top: "648.05px", ...styles.cls_010 }}>
                <Text style={styles.cls_010}>which have accrued prior to the termination of the Order.</Text>
              </View>
              <View style={{ position: "absolute", left: "56.70px", top: "653.76px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "325.98px", top: "653.76px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "56.70px", top: "659.52px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "325.98px", top: "659.51px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "56.70px", top: "665.28px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "325.98px", top: "665.27px", ...styles.cls_010 }}>
                <Text style={styles.cls_010}>termination.</Text>
              </View>
              <View style={{ position: "absolute", left: "56.70px", top: "671.04px", ...styles.cls_010 }}>
                <Text style={styles.cls_010}>the Supplier’s cost and expense.</Text>
              </View>
              <View style={{ position: "absolute", left: "325.98px", top: "671.03px", ...styles.cls_009 }}>
                <Text style={styles.cls_009}>CLAUSE 17. SUB-CONTRACTING</Text>
              </View>
              <View style={{ position: "absolute", left: "56.70px", top: "676.80px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "325.98px", top: "676.79px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "56.70px", top: "682.56px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "325.98px", top: "682.55px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "56.70px", top: "688.26px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "325.98px", top: "688.25px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "56.70px", top: "694.02px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "325.98px", top: "694.01px", ...styles.cls_010 }}>
                <Text style={styles.cls_010}>undertakes to ensure that its subcontractors adhere to the present GPTC.</Text>
              </View>
              <View style={{ position: "absolute", left: "56.70px", top: "699.78px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "325.98px", top: "699.78px", ...styles.cls_009 }}>
                <Text style={styles.cls_009}>CLAUSE 18. ASSIGNMENT</Text>
              </View>
              <View style={{ position: "absolute", left: "56.70px", top: "705.54px", ...styles.cls_010 }}>
                <Text style={styles.cls_010}>any of Engseen’s rights under the Contract.</Text>
              </View>
              <View style={{ position: "absolute", left: "325.98px", top: "705.54px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "56.70px", top: "711.30px", ...styles.cls_009 }}>
                <Text style={styles.cls_009}>CLAUSE 9. ACCEPTANCE OR TAKING-OVER</Text>
              </View>
              <View style={{ position: "absolute", left: "325.98px", top: "711.30px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "56.70px", top: "717.05px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "325.98px", top: "717.06px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "56.70px", top: "722.76px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "325.98px", top: "722.76px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "56.70px", top: "728.51px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "325.98px", top: "728.52px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "56.70px", top: "734.27px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "325.98px", top: "734.28px", ...styles.cls_010 }}>
                <Text style={styles.cls_010}>respect of the Order.</Text>
              </View>
              <View style={{ position: "absolute", left: "56.70px", top: "740.03px", ...styles.cls_010 }}>
                <Text style={styles.cls_010}>that the Goods delivered do not conform to the Order’s Specifications.</Text>
              </View>
              <View style={{ position: "absolute", left: "325.98px", top: "740.04px", ...styles.cls_009 }}>
                <Text style={styles.cls_009}>CLAUSE 19. STAMP DUTY</Text>
              </View>
              <View style={{ position: "absolute", left: "56.70px", top: "745.79px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "325.98px", top: "745.80px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "56.70px", top: "751.49px", ...styles.cls_010 }}>
                <Text style={styles.cls_010}>accordance with this Contract stating the date accordingly (“Taking-Over Notice”).</Text>
              </View>
              <View style={{ position: "absolute", left: "325.98px", top: "751.50px", ...styles.cls_010 }}>
                <Text style={styles.cls_010}>relation to this Order shall be borne by the Supplier.</Text>
              </View>
              <View style={{ position: "absolute", left: "56.70px", top: "757.25px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "325.98px", top: "757.26px", ...styles.cls_009 }}>
                <Text style={styles.cls_009}>CLAUSE 20. ENTIRE AGREEMENT</Text>
              </View>
              <View style={{ position: "absolute", left: "56.70px", top: "763.02px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "325.98px", top: "763.02px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "56.70px", top: "768.78px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "325.98px", top: "768.78px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "56.70px", top: "774.54px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "325.98px", top: "774.54px", ...styles.cls_010 }}>
                <Text style={styles.cls_010}>whether made in writing or orally of both parties made prior to the date of this Contract</Text>
              </View>
              <View style={{ position: "absolute", left: "56.70px", top: "780.30px", ...styles.cls_010 }}>
                <Text style={styles.cls_010}>the period specified by Engseen.</Text>
              </View>
              <View style={{ position: "absolute", left: "325.98px", top: "780.30px", ...styles.cls_009 }}>
                <Text style={styles.cls_009}>CLAUSE 21. GOVERNING LAW</Text>
              </View>
              <View style={{ position: "absolute", left: "56.70px", top: "786.00px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "325.98px", top: "786.00px", ...styles.cls_010 }}>
              ...
              <View style={{ position: "absolute", left: "56.70px", top: "791.76px", ...styles.cls_010 }}>
